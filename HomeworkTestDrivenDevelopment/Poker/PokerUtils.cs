...
namespace Poker
{
    ...
    {
        static public CardFace ReadFace(char ch)
        {
            switch (ch)
            {
                case '2':
        ...
        static public CardSuit ReadSuit(char ch)
        {
        ...
        static public Card ReadCard(string str)
        {
            return new Card(ReadFace(str[0]), ReadSuit(str[1]));
        }

        static public Hand ReadHand(string str)
        {
